...
export const Teorver = () => {
    ...
    useEffect(() => {
      if(flag){
        ...
        vib.map((num) => {
          if(arr.length === 0)
            ...
            arr[arr.length - 1] = {
              ...
              density2: (arr[arr.length - 1].quantity + 1) / 228
            }
          else{ 
            arr = [
              ...arr,
        ...
        let conMath3 = X - 1.96 * Math.sqrt(S2 / (n - 1))
        let conMath4 = X + 1.96 * Math.sqrt(S2 / (n - 1))
        ...
        arr[1] = {
          ...arr[1],
          quantity: arr[1].quantity + arr[0].quantity,
          inter1: arr[0].inter1,
          name: arr[1].inter1.toFixed(4)
        }
        arr.splice(0, 1);
        ...
        setCritThresholdPerson1(14.067)
        setCritThresholdPerson2(11.07)
      }
      setFlag(false)
    })
